...
class TrajectoryModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.sparse_weighted_adjacency_matrices = SparseWeightedAdjacency(
            number_asymmetric_conv_layer=number_asymmetric_conv_layer, obs_len=obs_len, spa_in_dims=in_dims, tem_in_dims=in_dims+1
        )

        # graph convolution
        self.stsgcn = SparseGraphConvolution(
            in_dims=in_dims, embedding_dims=embedding_dims // num_heads, dropout=dropout
        )
